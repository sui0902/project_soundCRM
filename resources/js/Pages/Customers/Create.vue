                              ...
                              <div class="flex flex-wrap -m-2">
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <input type="text" id="name" name="name" v-model="form.name" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <input type="number" id="postcode" name="postcode" @change="fetchAddress" v-model="form.postcode" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                                ...
                                <div class="p-2 w-full">
                                    <label class="block leading-7 text-sm text-gray-600 mb-3">性別</label>
                                    <div class="flex items-center space-x-8">
                                      <div class="flex items-center">
                                        <input type="radio" id="gender" name="gender" v-model="form.gender" value="0" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500 focus:ring-2">
                                        <label for="gender" class="ml-3 text-sm font-medium text-gray-700">男性</label>
                                      </div>
                                      <div class="flex items-center">
                                        <input type="radio" id="gender" name="gender" v-model="form.gender" value="1" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500 focus:ring-2">
                                        <label for="gender" class="ml-3 text-sm font-medium text-gray-700">女性</label>
                                      </div>
                                      <div class="flex items-center">
                                        <input type="radio" id="gender" name="gender" v-model="form.gender" value="2" class="w-4 h-4 text-cyan-600 bg-gray-100 border-gray-300 focus:ring-cyan-500 focus:ring-2">
                                ...
                                <div class="p-2 w-full">
                                  <div class="relative">
                                    ...
                                    <textarea id="memo" name="memo" v-model="form.memo" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-cyan-500 focus:bg-white focus:ring-2 focus:ring-cyan-500 h-32 text-base outline-none text-gray-700 py-1 px-3 resize-none leading-6 transition-colors duration-200 ease-in-out"></textarea>
                                    <InputError :message="errors.memo"/>
                                  </div>
                                </div>
                                <div class="p-2 w-full">
                                  <button class="flex mx-auto text-white bg-cyan-300 border-0 py-2 px-8 focus:outline-none hover:bg-cyan-500 rounded text-lg">顧客登録</button>
                                </div>
                              </div>
                            </div>
                          </div>
