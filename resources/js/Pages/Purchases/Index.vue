                                    ...
                                    <table class="table-auto w-full text-left whitespace-no-wrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100">購入日時</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr v-for="order in props.orders.data" :key="order.id">
                                                ...
                                                <td class="border-t-2 border-gray-200 px-4 py-3 text-lg text-gray-900">{{ dayjs(order.created_at).format('YYYY-MM-DD HH:mm:ss') }}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
